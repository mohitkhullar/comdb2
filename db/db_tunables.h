...
REGISTER_TUNABLE("foreign_db_auth_enabled", "Redirect extern auth data to remote server. (Default: off)", TUNABLE_BOOLEAN,
                 &gbl_fdb_auth_enabled, NOARG, NULL, NULL, NULL, NULL);
